...
export default function AccountOrderDetail() {
  ...
  function addAllItemsToCart(): { added: number; skipped: number } {
    let added = 0;
    let skipped = 0;
  ...
  function handleBuyAgain() {
    const { added, skipped } = addAllItemsToCart();
    if (added === 0) {
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap items-center gap-3 mb-10">
        ...
        <Button variant="outline" size="sm" icon={<ShoppingBag size={14} />} onClick={handleBuyAgain}>
          Buy again
        </Button>
        <Button variant="outline" size="sm" icon={<RotateCcw size={14} />} onClick={handleReorder}>
          Reorder & checkout
        </Button>
