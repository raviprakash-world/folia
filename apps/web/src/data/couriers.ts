...
export const couriers: Courier[] = [
  { id: 'swiftpost', name: 'SwiftPost', monogram: 'SP', color: '#2B4638', supportPhone: '1800 000 0142', supportEmail: 'support@swiftpost.example' },
  { id: 'cascade-express', name: 'Cascade Express', monogram: 'CE', color: '#4B7259', supportPhone: '1800 000 0198', supportEmail: 'help@cascadeexpress.example' },
  { id: 'trailrunner', name: 'TrailRunner Logistics', monogram: 'TR', color: '#C08A34', supportPhone: '1800 000 0176', supportEmail: 'support@trailrunnerlog.example' },
  { id: 'northline', name: 'Northline Courier', monogram: 'NL', color: '#A6553C', supportPhone: '1800 000 0123', supportEmail: 'care@northlinecourier.example' },
  { id: 'quickhatch', name: 'QuickHatch Delivery', monogram: 'QH', color: '#395A44', supportPhone: '1800 000 0165', supportEmail: 'support@quickhatch.example' },
];
